...
<html lang="en">
    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
            <div class="container">
                <a class="navbar-brand" href="#page-top">GoldMan</a>
                      ...
                      @if(count($portfolio) > 0)
                       @foreach($portfolio as $portfolios)
                        ...
                        <div class="portfolio-item">
                            <a class="portfolio-link" data-bs-toggle="modal" href="#portfolioModal1<?php echo $portfolios->id ?>">
                                <div class="portfolio-hover">
                                    <div class="portfolio-hover-content"><i class="fas fa-plus fa-3x"></i></div>
                                </div>
                                <img class="img-fluid" src="{{ url($portfolios->big_img) }}" alt="..." />
                            </a>
                            <div class="portfolio-caption">
                                <div class="portfolio-caption-heading">{{ $portfolios->title }}</div>
                                <div class="portfolio-caption-subheading text-muted">{{ $portfolios->client }}</div>
                            </div>
                        </div>
                    </div>
                     @endforeach
        ...
        <section class="page-section" id="about">
            <div class="container">
                ...
                <ul class="timeline">
                    ...
                    <li>
                        <div class="timeline-image"><img class="rounded-circle img-fluid" src="{{ url($abouts->image) }}" alt="..." /></div>
                        <div class="timeline-panel">
                            <div class="timeline-heading">
                                <h4>{{ $abouts->title }}</h4>
                                <h4 class="subheading">{{ $abouts->sub_title }}</h4>
                            </div>
                            <div class="timeline-body"><p class="text-muted">{{ $abouts->description }}</p></div>
                        </div>
                    </li>
        ...
        <section class="page-section" id="contact">
            <div class="container">
                ...
                <form id="contactForm" action="{{ route('contact-form.store') }}" method="POST">
                    @csrf
        ...
        <!-- Portfolio item 1 modal popup-->
         @if(count($portfolio) > 0)
        @foreach($portfolio as $portfolios)
        <div class="portfolio-modal modal fade" id="portfolioModal1<?php echo $portfolios->id ?>" tabindex="-1" role="dialog" aria-hidden="true">
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-8">
                                <div class="modal-body">
                                    <!-- Project details-->
                                    <h2 class="text-uppercase">{{ $portfolios->title}}</h2>
                                    <p class="item-intro text-muted">{{ $portfolios->sub_title}}</p>
                                    <img class="img-fluid d-block mx-auto" src="{{ url($portfolios->big_img)}}" alt="..." />
                                    <p>{{ $portfolios->sub_title}}</p>
